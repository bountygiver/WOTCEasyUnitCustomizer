//---------------------------------------------------------------------------------------
//  FILE:   XComDownloadableContentInfo_zzzWotcEasyUnitCustomizer.uc                                    
//           
...
class X2DownloadableContentInfo_zzzWotcEasyUnitCustomizer extends X2DownloadableContentInfo;
...
static event OnPostTemplatesCreated()
{
	...
	`log("==========X2DLC started==========", class'X2EPostGenerate_SuperUnitsPatcher'.default.LoggingEnabled, 'EasyCustomizer');
	
    class'X2FinalTemplatePreValidation'.static.CreateTemplates();

	`log("==========FIRST PASS PATCH COMPLETED==========", class'X2EPostGenerate_SuperUnitsPatcher'.default.LoggingEnabled, 'EasyCustomizer');

	class'X2EPostGenerate_SuperUnitsPatcher'.static.PostPatch();

	`log("==========X2DLC ended==========", class'X2EPostGenerate_SuperUnitsPatcher'.default.LoggingEnabled, 'EasyCustomizer');
}
